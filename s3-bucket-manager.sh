...
main_menu() {
  ...
  echo "5) Upload File to Bucket"
  echo "6) Download File from Bucket"
  echo "7) Get Bucket Size/Info"
  echo "8) Empty Bucket"
  echo "9) Enable Static Website Hosting"
  echo "10) Enable/Disable Versioning"
  echo "11) Add Tags to Bucket"
  echo "12) Set Bucket Policy (Public Read)"
  echo "13) Exit"
  echo "=============================="
